...
strLenX         = '500';	%X length
strLenY         = '500';	%Y length
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%기본 설정
            ...
            %    filename=getfield(ddir(i), 'name');
                ...
                %else
                    ...
                    temp = dir(strCDOMName);
                    hourMin = strcat(temp.name(length(temp.name)-12:length(temp.name)-9)); %%%%%파일명에 필요한 시분정보 추출
